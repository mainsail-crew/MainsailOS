...
const sidebars = {
  ...
  docsSidebar: [
    ...
    {type: 'category', label: 'Guides', collapsed: false, items: [
      ...
      {type: 'link', href: '/changelog#updating-from-ratos-v1', label: 'Updating from RatOS V1.x'},
    ]},
    {type: 'category', label: 'Supported Boards', collapsed: true, items: [
      {type: 'autogenerated', dirName: 'boards'}
    ]},
    {type: 'category', label: 'Supported Toolboards', collapsed: true, items: [
      {type: 'autogenerated', dirName: 'toolboards'}
    ]},
