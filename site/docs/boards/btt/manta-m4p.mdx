...
:::info
The Manta M4P is a Compute Module 4 (CM4) host board. RatOS supports CM4's as long as there's no eMMC (using micro SD card, recommended for ease of use) or at least 16gb eMMC storage.
